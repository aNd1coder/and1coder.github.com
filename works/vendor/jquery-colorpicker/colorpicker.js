    ...
    var ColorPicker = function () {
        ...
        downSelector = function (ev) {
            ...
            show = function (ev) {
                ...
                cal.css({left: left + 'px', top: (top + 5) + 'px'});
            ...
            init: function (opt) {
                ...
                return this.each(function () {
                    if (!$(this).data('colorpickerId')) {
                        ...
                        cal.find('.colorpicker_transparent')
                            .on('click', options.onTransparent);
